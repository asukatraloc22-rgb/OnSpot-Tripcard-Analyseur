...
export function normalizeReport(value: unknown): AuditReport | null {
  ...
  if (!Array.isArray(source.reminders) && source.raw && typeof source.raw === "object") return analyzeTrip(source.raw as Record<string, unknown>);
